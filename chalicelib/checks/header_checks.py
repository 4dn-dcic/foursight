...
def prepare_static_headers_Chromatin_Tracing(connection, **kwargs):
    ...
    add_search = '/search/?experiments_in_set.experiment_type=Chromatin+Tracing&type=ExperimentSet&frame=object'
    remove_search = '/search/?experiments_in_set.experiment_type!=Chromatin+Tracing&type=ExperimentSet&frame=object'
