...
class TestGenerateHiglassViewConfFiles(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        reference_file_types = ("beddb", "chromsizes")
        processed_file_types = ("mcool")
    ...
    def test_check_found_viewconf_to_generate(self):
        ...
        # Check is ready to generate
        check["summary"] = "Ready to generate 1 Higlass view configs"

        # Allow action is True
        self.assertTrue(check["allow_action"])

        # File is in full_action's target_files
...
# File has static content with auto generated hvc field
# Add mcool file with Human genome assembly
# Run check
# Check is ready to generate
# Allow action is True
# File is in full_action's target_files
